...
parser.add_argument('--checkpoint_dir', type=str, default='/content/drive/MyDrive/RecSys/FinalProject/models/checkpoint_yoochhose/one direction')
...
def main():
    ...
    model = lib.GRU4REC(input_size, hidden_size, output_size, final_act=final_act,
                        ...
                        dropout_input=dropout_input, dropout_hidden=dropout_hidden, embedding_dim=embedding_dim, bidirectional=args.is_bidirectional)
